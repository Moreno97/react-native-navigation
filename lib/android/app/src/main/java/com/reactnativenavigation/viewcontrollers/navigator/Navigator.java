...
public class Navigator extends ParentController {
    ...
    public void showSnackBar(final String componentId, Options options, CommandListener listener) {
        String getTitle = options.snackBarOptions.title.toString();

        Snackbar.make(view, getTitle, Snackbar.LENGTH_SHORT).show();
